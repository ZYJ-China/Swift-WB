...
- (void)loadImageNearIndex:(int)index
{
    if (index > 0) {
        ...
        [[SDWebImageManager sharedManager] downloadImageWithURL:photo.url options:nil progress:nil completed:^(UIImage *image, NSError *error, SDImageCacheType cacheType, BOOL finished, NSURL *imageURL) {
            //do nothing
        }];
